...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";var _react=__webpack_require__(1);var _react2=_interopRequireDefault(_react);var _svgDrag=__webpack_require__(33);var _svgDrag2=_interopRequireDefault(_svgDrag);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}var paper=Raphael(20,20,500,250);var path=paper.circle(125,125,100).attr({"stroke-width":8});var startPoint=path.getPointAtLength(0);var circle=paper.ellipse(startPoint.x,startPoint.y,10,10).attr({stroke:"none",fill:"#f00"});var text=paper.text().attr({x:135,y:125,"font-size":36,"font-family":"Arial, Helvetica, sans-serif",text:"0%"});var drag=new _svgDrag2.default(path,circle,function(percent){text.attr({text:percent+"%"});});
